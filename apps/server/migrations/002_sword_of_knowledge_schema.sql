-- Ensures sword_of_knowledge schema exists for databases that already applied
-- an older 001_init.sql (app schema only). Safe no-op when 001 already created these.
